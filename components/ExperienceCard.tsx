...
function ExperienceCard({ experience }: Props) {
  return (
    <article className="w-screen flex-shrink-0 overflow-y-scroll snap-center flex flex-col space-y-2 md:space-y-5 lg:space-y-8 xl:space-y-12 px-5 items-center justify-center p-1 md:p-6 lg:p-20 xl:p-36 h-screen">
      <motion.img
        initial={{
          y: -200,
          opacity: 0,
