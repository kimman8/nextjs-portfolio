      ...
      <div className='flex flex-col space-y-10'>
        ...
        <div className='space-y-10'>
          <div className='flex items-center space-x-5 justify-center'>
            <PhoneIcon className='h-7 w-7 animate-pulse text-[#64FFDB]' />
            {/* <p className='text-2xl'>0438 888 813</p> */}
            <p className='text-2xl text-[#8791AF]'>{pageInfo?.phoneNumber}</p>
          </div>
          <div className='flex items-center space-x-5 justify-center'>
            <EnvelopeIcon className='h-7 w-7 animate-pulse text-[#64FFDB]' />
            <p className='text-2xl text-[#8791AF]'>klyuen91@gmail.com</p>
          </div>
          {/* <div className='flex items-center space-x-5 justify-center'>
        ...
        >
          <div className='flex space-x-2 text-[#6E7995]'>
            <input
              type='text'
              placeholder='Name'
          ...
          <button
            type='submit'
            className='text-[#0A192F] bg-[#64FFDB] rounded-md px-10 py-5 font-bold text-lg'
          >
            Submit
          </button>
        </form>
